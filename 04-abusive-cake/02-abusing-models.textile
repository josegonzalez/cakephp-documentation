...
Behaviors will not work because they aren't really attached. Callbacks won't be fired. You can't access it in the @$associations@ array. Good luck.
...
The @ConnectionManager@ class can be used to get a datasource.
